...
const vd = (await youtubeSearch(text)).video[0]
const { authorName, description, videoId, durationH, viewH, publishedTime, thumbnail, title } = vd
...
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: wm, orderTitle: 'Bang', thumbnail: imagen3, sellerJid: '0@s.whatsapp.net'}}}