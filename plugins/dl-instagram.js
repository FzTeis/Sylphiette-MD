...
const handler = async (m, {conn, args, command, usedPrefix}) => {
  if (!args[0]) throw `> 🌴 Ingresa un enlace de Instagram. Ejemplo: #${command} https://www.instagram.com/reel/C3VQpl2AKB8/?igsh=aXJzMnJtdTNsZDc1`;;
  m.react(rwait)
  try {
      ...
      try {
        ...
        try {
          ...
          try {
            ...
            throw `> ⚠️ Ocurrió un error, inténtalo nuevamente.`;
          }
        }
      }
    }
